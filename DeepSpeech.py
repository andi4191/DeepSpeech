...
def calculate_mean_edit_distance_and_loss(batch_set, dropout):
    ...
    # Calculate the logits of the batch using GRuRNN
    logits = GRuRNN(batch_x, tf.to_int64(batch_seq_len), dropout)
...
def export():
    ...
    with tf.device('/cpu:0'):
        ...
        # Calculate the logits of the batch using GRuRNN
        logits = GRuRNN(input_tensor, tf.to_int64(seq_length), no_dropout)
